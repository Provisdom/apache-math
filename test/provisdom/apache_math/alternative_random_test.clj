...
(ct/deftest quasi-rnd-vector-lazy-test
  (t/with-instrument `alt-random/quasi-rnd-vector-lazy
    (t/is-spec-check alt-random/quasi-rnd-vector-lazy))
